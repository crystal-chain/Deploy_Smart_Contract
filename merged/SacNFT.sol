...
contract SacNFT is ERC721URIStorage {
    ...
    function generateSac( address minter, string memory modele, string memory couleur, uint256 taille, string memory numeroserie) isMinter public returns(uint256){
        _tokenIds++;
